...
rho = [1 1 1 1];
mmpolar(theta,rho,'w.','FontSize',16,'RLimit',[0 1],'RTickValue',[0 1/3 2/3 1],'RTickLabel',cellstr(['  '; '60'; '30'; '  ']),'TTickLabel',cellstr(['270'; '240'; '210';'180'; '150'; '120'; ' 90'; ' 60'; ' 30'; ' 0 '; '330'; '300']),'RTickAngle',180)
hold on;
...
for s = 1:length(SVs)
    ...
    for j = 1:length(num_lines)
        ...
        if(xyvec(idx(1),4)==1)
            mmpolar(theta,rho,'b','LineWidth',2,'FontSize',16,'RLimit',[0 1],'RTickValue',[0 1/3 2/3 1],'RTickLabel',cellstr(['  '; '60'; '30'; '  ']),'TTickLabel',cellstr(['270'; '240'; '210';'180'; '150'; '120'; ' 90'; ' 60'; ' 30'; ' 0 '; '330'; '300']),'RTickAngle',180)
        else
            mmpolar(theta,rho,'b:','LineWidth',2,'FontSize',16,'RLimit',[0 1],'RTickValue',[0 1/3 2/3 1],'RTickLabel',cellstr(['  '; '60'; '30'; '  ']),'TTickLabel',cellstr(['270'; '240'; '210';'180'; '150'; '120'; ' 90'; ' 60'; ' 30'; ' 0 '; '330'; '300']),'RTickAngle',180)
        end
    end
    ...
    if(xyvec(end,4)==1)
        mmpolar(t,r,'k*','MarkerSize',10,'FontSize',16,'Font','Helvetica','RLimit',[0 1],'RTickValue',[0 1/3 2/3 1],'RTickLabel',cellstr(['  '; '60'; '30'; '  ']),'TTickLabel',cellstr(['270'; '240'; '210';'180'; '150'; '120'; ' 90'; ' 60'; ' 30'; ' 0 '; '330'; '300']),'RTickAngle',180);
    else
        mmpolar(t,r,'r*','MarkerSize',10,'FontSize',16,'Font','Helvetica','RLimit',[0 1],'RTickValue',[0 1/3 2/3 1],'RTickLabel',cellstr(['  '; '60'; '30'; '  ']),'TTickLabel',cellstr(['270'; '240'; '210';'180'; '150'; '120'; ' 90'; ' 60'; ' 30'; ' 0 '; '330'; '300']),'RTickAngle',180);
    end
